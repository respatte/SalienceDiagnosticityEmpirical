...
# GATHER DATA
# Define AOIs
AOIs.infants.head <- data.frame(AOI_type=c("Reg","Flip"),L=c(1031,1920-1031-450),R=c(1031+450,1920-1031),T=c(197,197),B=c(197+450,197+450))
AOIs.infants.tail <- data.frame(AOI_type=c("Reg","Flip"),L=c(390,1920-390-450),R=c(390+450,1920-390),T=c(299,299),B=c(299+450,299+450))
...
LT.infants <- raw_data.infants %>%
  ...
  LT_data.to_eyetrackingR(AOIs.adults, set.trial.start = F) %>%
